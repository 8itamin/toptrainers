...
from toptrainers_api.modules.media.router import router as media_router
from toptrainers_api.modules.programs.assignments_router import router as program_assignments_router
...
from toptrainers_api.modules.tasks.router import router as tasks_router
