...
@Component({
  ...
  template: `
    <main class="landing">
      ...
      <section class="hero shell">
        ...
        <aside class="mission-card" aria-label="Цели первого года">
          ...
          <div class="mission-grid">
            ...
            <div><b class="lime">№1</b><span>в спорте РФ</span></div>
          </div>
        </aside>
      </section>
      ...
      <section class="ecosystem shell" aria-label="Три слоя экосистемы">
      ...
      <section id="advantages" class="advantages shell">
        ...
        <aside class="showcase-preview" aria-label="Предпросмотр витрины тренера"><span>ВИТРИНА ТРЕНЕРА</span><strong>ivanov<br />.toptrainers.ru</strong><small>Программы · товары · результаты</small></aside>
      </section>

      <section id="pricing" class="competition shell">
        <div class="section-kicker">04 <span>СОРЕВНОВАНИЯ</span></div>
