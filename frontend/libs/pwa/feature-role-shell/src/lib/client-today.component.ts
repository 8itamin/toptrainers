  ...
  template: `
    <div class="screen">
      ...
      <nav class="tabbar" aria-label="Навигация">
        ...
        <a class="tab" routerLink="/client/history"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3v18h18M7 14l3-3 3 3 5-6" /></svg><span>История</span></a>
