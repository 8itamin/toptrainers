...
@Component({
  ...
  template: `
    ...
    <section id="programs" class="card"><div class="card__header"><h2>Программы</h2><a routerLink="/trainer/programs">Открыть конструктор</a></div><p>Собирайте библиотеку упражнений и сохранённые тренировки для будущих программ.</p>
